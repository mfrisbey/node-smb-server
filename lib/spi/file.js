...
/**
 * Retrieves the file's context.
 * @returns {SMBContext} The context for the file.
 */
...
/**
 * Retrieves the logger instance that should be used for log messages for the File.
