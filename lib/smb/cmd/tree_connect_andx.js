...
function handle(msg, commandId, commandParams, commandData, commandParamsOffset, commandDataOffset, connection, server, cb) {
  ...
  server.connectShare(session, shareName, shareLevelPassword, function (err, share) {
    if (err) {
      result = {
    ...
    var service = share.isNamedPipe() ? SMB.SERVICE_NAMEDPIPE : SMB.SERVICE_DISKSHARE;
