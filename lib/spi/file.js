 ...
 */
var File = function (filePath, tree, context) {
  if (!(this instanceof File)) {
    return new File(filePath, tree, context);
  }
  this.filePath = tree.unicodeNormalize(filePath);
  this.fileName = utils.getPathName(this.filePath);
  this.tree = tree;
  this.context = context ? context : tree.createContext().withLabel('SPIFile').requestless();
};
