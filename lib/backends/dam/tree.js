 ...
 */
DAMTree.prototype.createFileInstance = function (context, filePath, content, fileLength, cb) {
  ...
  DAMFile.createInstance(context, filePath, this, content, fileLength, cb);
};
 ...
 */
DAMTree.prototype.createFileExt = function (context, name, cb) {
  var logger = context.spi();
 ...
 */
DAMTree.prototype.createDirectoryExt = function (context, name, cb) {
  var logger = context.spi();
 ...
 * @param {SMBError} cb.error error (non-null if an error occurred)
 */
DAMTree.prototype.deleteExt = function (context, name, cb) {
  var logger = context.spi();
 ...
 * @param {SMBError} cb.error error (non-null if an error occurred)
 */
DAMTree.prototype.deleteDirectoryExt = function (context, name, cb) {
  var logger = context.spi();
 ...
 */
function _updateTitle(context, path, cb) {
  var logger = context.spi();
 ...
 * @param {SMBError} cb.error error (non-null if an error occurred)
 */
DAMTree.prototype.renameExt = function (context, oldName, newName, cb) {
  var logger = context.spi();
  ...
  webutils.submitRequest(options, function (err, resp, body) {
    if (err) {
      ...
      _updateTitle.call(self, context, newName, cb);
    }
  });
};
