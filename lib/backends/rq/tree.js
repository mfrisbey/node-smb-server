...
RQTree.prototype.isExtensionMode = function () {
  return this.share.isExtensionMode();
};
...
function _trimAemExtension(value) {
  if (this.isExtensionMode()) {
    if (utils.getFileExtension(value) == 'aem') {
...
RQTree.prototype.exists = function (name, cb) {
  ...
  var rqlog = this.getRqLogger();
  name = _trimAemExtension.call(this, name);
...
RQTree.prototype.list = function (pattern, cb) {
  ...
  if (filter == '*') {
    ...
    pattern = _trimAemExtension.call(self, pattern);
