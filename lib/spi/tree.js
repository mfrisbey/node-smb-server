...
/**
 * Creates a new SMBContext instance.
 * @returns {SMBContext} The newly created instance.
 */
Tree.prototype.createContext = function () {
...
Tree.prototype.exists = function (name, cb) {
  this.existsExt(this.createContext().withLabel('SPITree.Exists').requestless(), name, cb);
};
...
Tree.prototype.open = function (name, cb) {
  this.openExt(this.createContext().withLabel('SPITree.Open').requestless(), name, cb);
};
...
Tree.prototype.list = function (pattern, cb) {
  this.listExt(this.createContext().withLabel('SPITree.List').requestless(), pattern, cb);
};
...
Tree.prototype.createFile = function (name, cb) {
  this.createFileExt(this.createContext().withLabel('SPITree.CreateFile').requestless(), name, cb);
};
...
Tree.prototype.createDirectory = function (name, cb) {
  this.createDirectoryExt(this.createContext().withLabel('SPITree.CreateDirectory').requestless(), name, cb);
};
...
Tree.prototype.delete = function (name, cb) {
  this.deleteExt(this.createContext().withLabel('SPITree.Delete').requestless(), name, cb);
};
...
Tree.prototype.deleteDirectory = function (name, cb) {
  this.deleteDirectoryExt(this.createContext().withLabel('SPITree.DeleteDirectory').requestless(), name, cb);
};
...
Tree.prototype.rename = function (oldName, newName, cb) {
  this.renameExt(this.createContext().withLabel('SPITree.Rename').requestless(), oldName, newName, cb);
};
...
Tree.prototype.refresh = function (folderPath, deep, cb) {
  this.refreshExt(this.createContext().withLabel('SPITree.Refresh').requestless(), folderPath, deep, cb);
};
...
Tree.prototype.clearCache = function (cb) {
  this.clearCacheExt(this.createContext().withLabel('SPITree.ClearCache').requestless(), cb);
};

/**
 * Extended version of clearCache to clear the tree's cache. Default implementation does nothing.
 * @param {SMBContext} context Additional information that can provide enhanced capabilities throughout the workflow.
 * @param {function} cb Will be invoked when the operation is complete.
 * @param {string|Error} cb.err Will be truthy if there were errors during the operation.
 */
Tree.prototype.clearCacheExt = function (context, cb) {
  cb();
};
