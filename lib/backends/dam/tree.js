 ...
 */
var DAMTree = function (share, content, tempFilesTree, context) {
  if (!(this instanceof DAMTree)) {
    return new DAMTree(share, content, tempFilesTree, context);
  }

  JCRTree.call(this, share, content, tempFilesTree, context);
};
