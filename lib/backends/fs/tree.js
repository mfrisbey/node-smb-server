 ...
 */
var FSTree = function (share, context) {
  if (!(this instanceof FSTree)) {
    return new FSTree(share, context);
  }
...
FSTree.prototype.getPerformanceLogger = function () {
  return this.getContext().perf();
};
...
FSTree.prototype.exists = function (name, cb) {
  ...
  var perflog = this.getPerformanceLogger();
