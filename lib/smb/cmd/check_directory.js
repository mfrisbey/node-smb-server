 ...
 */
function handle(context, msg, commandId, commandParams, commandData, commandParamsOffset, commandDataOffset, connection, server, descriptionCb, cb) {
  ...
  descriptionCb(msg.directoryName, function () {
    ...
    tree.existsExt(context, msg.directoryName, function (err, exists) {
      if (err) {
        cb({
