...
SMBTree.prototype.exists = function (name, cb) {
  this.existsExt(new SMBContext().withLabel('SMBTree.Exists').requestless(), name, cb);
};
...
SMBTree.prototype.openOrCreate = function (name, createDisposition, openTargetDirectory, cb) {
  this.openOrCreateExt(new SMBContext().withLabel('SMBTree.OpenOrCreate').requestless(), name, createDisposition, openTargetDirectory, cb);
};
...
SMBTree.prototype.open = function (name, cb) {
  this.openExt(new SMBContext().withLabel('SMBTree.Open').requestless(), name, cb);
};
...
SMBTree.prototype.reopen = function (name, fid, cb) {
  this.reopenExt(new SMBContext().withLabel('SMBTree.Reopen').requestless(), name, fid, cb);
};
...
SMBTree.prototype.list = function (pattern, cb) {
  this.listExt(new SMBContext().withLabel('SMBTree.List').requestless(), pattern, cb);
};
...
SMBTree.prototype.createFile = function (name, cb) {
  this.createFileExt(new SMBContext().withLabel('SMBTree.CreateFile').requestless(), name, cb);
};
...
SMBTree.prototype.createDirectory = function (name, cb) {
  this.createDirectoryExt(new SMBContext().withLabel('SMBTree.CreateDirectory').requestless(), name, cb);
};
...
SMBTree.prototype.delete = function (name, cb) {
  this.deleteExt(new SMBContext().withLabel('SMBTree.Delete').requestless(), name, cb);
};
...
SMBTree.prototype.deleteDirectory = function (name, cb) {
  this.deleteDirectoryExt(new SMBContext().withLabel('SMBTree.DeleteDirectory').requestless(), name, cb);
};
...
SMBTree.prototype.rename = function (nameOrFile, newName, cb) {
  this.renameExt(new SMBContext().withLabel('SMBTree.Rename').requestless(), nameOrFile, newName, cb);
};
...
SMBTree.prototype.refresh = function (folderPath, deep, cb) {
  this.refreshExt(new SMBContext().withLabel('SMBTree.Refresh').requestless(), folderPath, deep, cb);
};
