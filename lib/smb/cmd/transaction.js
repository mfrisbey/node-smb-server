...
var executeHandler = require('../handlerExecutor');
 ...
 */
function handle(context, msg, commandId, commandParams, commandData, commandParamsOffset, commandDataOffset, connection, server, descCb, cb) {
  var logger = context.smb();
  // decode params
  ...
  descCb(null, function () {
    ...
    if (handler) {
      executeHandler(subCommand, handler, context, msg, msg.subCommandId, subParams, subData, msg.parameterOffset, msg.dataOffset, connection, server, function (result) {
